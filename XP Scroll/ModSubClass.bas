...
Public Up_ As PictureBox
Public UpHot_ As PictureBox
Public UpPres_ As PictureBox
Public Down_ As PictureBox
Public DownHot_ As PictureBox
Public DownPres_ As PictureBox
Public Bar_ As PictureBox
Public BarHot_ As PictureBox
Public BarPres_ As PictureBox
Public BarMidColor
...
Public Sub Subclass(Pic As PictureBox, PropName As Long)
    ...
    Case WM_MOUSEMOVE
        ...
        If GetProp(hWnd, "Tracking") = 0 Then
            ...
            If pObject <> 0 Then
                ...
                Case 0
                    Set Pic.Picture = UpHot_.Picture
                Case 1
                    Set Pic.Picture = DownHot_.Picture
                Case 2
                    Set Pic.Picture = BarHot_.Picture
                    PaintBar Pic
                End Select
...
MOUSEOUT:
        ...
        If pObject Then
            ...
            Select Case GetProp(hWnd, "Name")
            Case 0
                Set Pic.Picture = Up_.Picture
            Case 1
                Set Pic.Picture = Down_.Picture
            Case 2
                Set Pic.Picture = Bar_.Picture
                PaintBar Pic
            End Select
...
MOUSEIN:
        ...
        If pObject Then
            ...
            Select Case GetProp(hWnd, "Name")
            Case 0
                Set Pic.Picture = UpPres_.Picture
            Case 1
                Set Pic.Picture = DownPres_.Picture
            Case 2
                Set Pic.Picture = BarPres_.Picture
                PaintBar Pic
            End Select
